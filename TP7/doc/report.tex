...
To create the foam over the waves, we first need to generate and understand the foam dynamics. If we think about the environment conditions to generate the foam, the waves must be sufficiently high enough to break and produce the foam(slope greater than 1/6). 
